...
(function() {
    ...
    function copyUrls() {
        var elements = document.querySelectorAll('article[data-testid="result"] a[data-testid="result-title-a"]');
        var hrefString = "";
        var count = 0;
    ...
    function copyUrlsAndTitles() {
        ...
        var count = 0;
        elements.forEach(function(element) {
            var hrefElement = element.querySelector('a[data-testid="result-title-a"]');
    ...
    function copyTitles() {
        var elements = document.querySelectorAll('article[data-testid="result"] h2');
        var titleString = "";
        var count = 0;
        elements.forEach(function(element) {
