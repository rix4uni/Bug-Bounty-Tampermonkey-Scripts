...
(function() {
    ...
    function copyUrls() {
        var elements = document.querySelectorAll('.OrganicTitle-Link');
        var hrefString = "";
        var count = 0;
    ...
    function copyUrlsAndTitles() {
        var elements = document.querySelectorAll('.Organic');
        var hrefTitleString = "";
        var count = 0;
        elements.forEach(function(element) {
            var hrefElement = element.querySelector('.OrganicTitle-Link');
            var titleElement = element.querySelector('.OrganicTitle-LinkText');
    ...
    function copyTitles() {
        var elements = document.querySelectorAll('.OrganicTitle-LinkText');
        var titleString = "";
        var count = 0;
        elements.forEach(function(element) {
