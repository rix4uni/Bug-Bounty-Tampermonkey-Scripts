...
(function() {
    ...
    function copyUrls() {
        var elements = document.querySelectorAll('div.snippet a.h');
        var hrefString = "";
        var count = 0;
    ...
    function copyUrlsAndTitles() {
        var elements = document.querySelectorAll('div.snippet');
        var hrefTitleString = "";
        var count = 0;
        elements.forEach(function(element) {
            var hrefElement = element.querySelector('a.h');
            var titleElement = element.querySelector('div.title');
    ...
    function copyTitles() {
        var elements = document.querySelectorAll('div.snippet div.title');
        var titleString = "";
        var count = 0;
        elements.forEach(function(element) {
